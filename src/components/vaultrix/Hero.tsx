...
const floaters = [
  { src: ASSETS.hero.floaters.discord,   x: "8%",  y: "20%", color: "from-indigo-500 to-purple-600", delay: 0 },
  { src: ASSETS.hero.floaters.roblox,    x: "85%", y: "15%", color: "from-emerald-400 to-teal-500", delay: 0.5 },
  { src: ASSETS.hero.floaters.spotify,   x: "12%", y: "75%", color: "from-green-400 to-emerald-500", delay: 1 },
  { src: ASSETS.hero.floaters.netflix,   x: "88%", y: "70%", color: "from-rose-400 to-red-600", delay: 1.5 },
  { src: ASSETS.hero.floaters.server,    x: "78%", y: "45%", color: "from-blue-400 to-indigo-500", delay: 2 },
  { src: ASSETS.hero.floaters.minecraft, x: "5%",  y: "48%", color: "from-green-500 to-lime-500", delay: 2.5 },
];
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-24 pb-16">
      ...
      <div className="absolute inset-0 -z-20">
        <img src={ASSETS.hero.background} alt="" aria-hidden className="h-full w-full object-cover opacity-20" loading="eager" />
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute bottom-1/4 right-1/4 h-[500px] w-[500px] rounded-full bg-purple/25 blur-[120px] animate-pulse-glow" style={{ animationDelay: "1.5s" }} />
      ...
      <div className="container relative mx-auto px-4 text-center max-w-5xl">
        ...
        >
          Nitro, Robux, VPS Hosting, Streaming Services and more.
        ...
        >
          <span className="flex items-center gap-1.5"><Zap className="h-3.5 w-3.5 text-orange" /> Instant Delivery</span>
          <span className="flex items-center gap-1.5"><Sparkles className="h-3.5 w-3.5 text-purple" /> Legal & Warrantied</span>
          <span className="flex items-center gap-1.5"><MessageCircle className="h-3.5 w-3.5 text-orange" /> 24/7 Support</span>
        </motion.div>
      </div>
    </section>
  );
