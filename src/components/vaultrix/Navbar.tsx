...
import { categories, categoryPath } from "@/data/products";
    ...
    <>
      <motion.header
        ...
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
          scrolled ? "py-1.5" : "py-2.5 sm:py-4"
        }`}
      >
        <div className="container mx-auto px-4">
          <div
            className={`mx-auto flex items-center justify-between rounded-2xl px-3 py-2 transition-all duration-500 sm:px-4 sm:py-2.5 ${
